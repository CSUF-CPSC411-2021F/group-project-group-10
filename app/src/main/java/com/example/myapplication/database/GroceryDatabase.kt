...
/**
 * Manages the database that stores the Grocery table and its entitites.
...
abstract class GroceryDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: GroceryDatabase? = null // This class
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        GroceryDatabase::class.java, // Your database class
                        "grocery_database"
                    )
